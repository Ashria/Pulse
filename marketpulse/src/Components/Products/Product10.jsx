...
import a1 from "../images/shop8.jpg"
  ...
  <div class=" px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0" data-aos="fade-left" data-aos-duration="2000">
        ...
        <h1 class="text-blue-700 text-3xl title-font font-bold Aurora my-4">Jackie</h1>
        <div className='transition-all'>
      <div className="flex border-b">
        <a 
          className={`flex-grow py-2  text-lg cursor-pointer px-1 ${show2 ? 'text-red-500 border-sky-500' : 'border-gray-300'}`} 
          onClick={() => { setShow2(true); setShow(false); }}
        >
          Description
        </a>
        <a 
          className={`flex-grow py-2  cursor-pointer text-lg px-1 ${show ? 'text-red-500 border-sky-500' : 'border-gray-300'}`} 
