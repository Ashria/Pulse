...
import a1 from "../images/shop7.jpg"
  ...
  <div class=" px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0" data-aos="fade-left" data-aos-duration="2000">
        ...
        <h1 class="text-blue-700 text-3xl title-font font-bold Aurora my-4">Baby bloom</h1>
        <div className='transition-all'>
      <div className="flex border-b">
        <a 
          className={`flex-grow py-2  text-lg px-1 cursor-pointer ${show2 ? 'text-red-500 border-sky-500' : 'border-gray-300'}`} 
          onClick={() => { setShow2(true); setShow(false); }}
        >
          Description
        </a>
        <a 
          className={`flex-grow py-2 text-lg px-1 cursor-pointer ${show ? 'text-red-500 border-sky-500' : 'border-gray-300'}`} 
...
<h2 className='my-4 text-center text-sky-400 font-bold'> To see more scroll right</h2>
    ...
    <div class="flex flex-wrap -m-4">
      ...
      <img alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded-2xl  shadow-2xl" data-aos="fade-right" data-aos-duration="2000" src={a1}/>
    </div>
  </div>
</section>
